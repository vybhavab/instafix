export const elements = {
  ...
  lensProfile: document.getElementById('lensProfile'),
  lensProfileHelp: document.getElementById('lensProfileHelp'),
  distortionAmountControl: document.getElementById('distortionAmountControl'),
